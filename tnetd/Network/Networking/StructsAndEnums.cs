...
namespace TNetD.Network.Networking
{
    ...
    public enum PacketType
    {
        ...
        TPT_CONS_TX_FETCH_REQUEST = 0x33,
        TPT_CONS_TX_FETCH_RESPONSE = 0x34,
        TPT_CONS_BALLOT_REQUEST = 0x35,
        TPT_CONS_BALLOT_RESPONSE = 0x36,
        TPT_CONS_BALLOT_AGREE_REQUEST = 0x37,
        TPT_CONS_BALLOT_AGREE_RESPONSE = 0x38,   
