...
namespace Grapevine
{
    ...
    public abstract class Responder
    {
        ...
        /// </summary>
        protected virtual void NotFound(HttpListenerContext context, string payload = "<h1>The Resource is Not Found</h1>", ContentType contentType = ContentType.HTML)
        {
            var buffer = Encoding.UTF8.GetBytes(payload);
            var length = buffer.Length;
        ...
        {
            var json = JsonConvert.SerializeObject(obj, Common.JSON_SERIALIZER_SETTINGS);
