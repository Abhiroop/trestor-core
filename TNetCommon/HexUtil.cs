...
namespace TNetCommon
{
    ...
    public sealed class HexUtil
    {
        ...
        /// <summary>
        /// Converts the input bytes array to a String assuming each character as a hexadecimal character.
        /// </summary>
        /// <param name="bytes">hex encoded bytes to be converted to the string</param>
        /// <param name="uppercase">sets the case of the encoded string</param>
        /// <returns>A string representation of the input bytes assuming Hex encoding</returns>
        public static string ToString(byte[] bytes, bool uppercase)
        {
            ...
            {
                throw new Exception("Error in HexEncode" + e.Message);
            }
        }
        ...
        /// at least two characters long else false.</returns>
        ...
        /// <summary>
        /// Checks to see if the input string is not null and at least two
        /// characters long
        /// </summary>
        /// <param name="hexString">string to be tested</param>
        /// <returns>true if hexString is not null and at least two
        ...
        public static byte[] CreateLegalByteArray(byte[] inputBytes, int requiredSize)
        {
            ...
            {
                //create a new Byte array of required length and fill the content with
